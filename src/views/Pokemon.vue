...
<template>
    <div :class="'bg-' + pokemon.type[0].toLowerCase()">
        <section class="pokemon mx-auto position-relative overflow-hidden">

            <img :src="getImage( pokemon.id )" :alt="pokemon.name.english" width="400" height="400" class="pokemon-image mx-auto d-block">

            <div class="pokemon-meta bg-light d-block text-body w-100 spacing">
